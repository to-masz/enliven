...
# A Matrix / Vector literal.
exports.MatVec = class MatVec extends Base
  constructor: (@objects, @type) ->
  ...
  compileNode: (o) ->
    ...
    if fragmentsToText(answer).indexOf('\n') >= 0
      ...
      answer.unshift @makeCode "new #{ucfirst @type}(["
      answer.push @makeCode "])"
    answer
...
exports.InlineWorker = class InlineWorker extends Base
  ...
  compileNode: (o) ->
    ...
    answer = []
    compiledBody = fragmentsToText(@body.compileToFragments Block.wrap([o]), LEVEL_PAREN);
    ...
    klass = new Class @variable, new Value(new Literal utility "codeWorker")
    klass.body = Block.wrap([
        new Assign new Value(new Literal("this"), [new Access(new Literal "dataURI")], 'this'), new Value(new Literal dataURI)
        new Assign new Value(new Literal("this"), [new Access(new Literal "name")], 'this'), new Value(new Literal "\""+klass.determineName()+"\"")
      ])
...
exports.ModelClass = class ModelClass extends Base
  constructor: (@variable, @body) ->

  children: ['variable', 'body']
  
  compileNode: (o) ->
    klass = new Class @variable, new Value(new Literal "ModelObject"), @body
    klass.compileToFragments o


#### Scene

exports.SceneClass = class SceneClass extends Base
  constructor: (@variable, @body) ->

  children: ['variable', 'body']

  compileNode: (o) ->
    klass = new Class @variable, new Value(new Literal "Scene"), @body
    klass.compileToFragments o
...
exports.Shader = class Shader extends Base
  constructor: (@variable, @vertex, @fragment, @options = new Obj) ->
  ...
  compileNode: (o) ->
    ...
    vertexShader = @vertex.value # @scanShader 
    fragmentShader = @fragment.value
    ...
    assignVertex = new Assign (new Value(new Literal("window.Enliven.ShaderSources"))).add(new Index(new Value(new Literal "\"#{@variable.base.value}.vertex\""))), new Value(new Literal vertexShader);
    assignFragment = new Assign (new Value(new Literal("window.Enliven.ShaderSources"))).add(new Index(new Value(new Literal "\"#{@variable.base.value}.fragment\""))), new Value(new Literal fragmentShader);
    
    
    [].concat assignVertex.compileToFragments(o), @makeCode(";"), assignFragment.compileToFragments(o)
...
exports.Assign = class Assign extends Base
  ...
  compileNode: (o) ->
    ...
    answer = answer.concat @makeCode(" #{ @context or '=' } "), val
...
exports.Op = class Op extends Base
  ...
  compileNode: (o) ->
    ...
    return @compileCustomOperator o if CUSTOM_OPERATOR.test @operator
  ...
  # Replaces operator with execution of operators method from object prototype or overrided by given class/object
  compileCustomOperator: (o) ->
    utility "operators"
    answer = [].concat @makeCode('('), @first.compileToFragments(o, LEVEL_OP), @makeCode(').operators("' + @operator + '",'),@second.compileToFragments(o, LEVEL_OP), @makeCode(')')
...
UTILITIES =
  ...
  operators: -> '''
    Object.prototype.operators = function(operator, object) { switch (operator) {case '+': return this + object;case '-': return this - object;case '/':return this / object;case '*':return this * object;case '%':return this % object;case '^':return this ^ object;default:throw SyntaxError('Object does not support \"' + operator + '\" operator');}}
  '''
  
  codeWorker: -> '''
    (function() {function CodeWorker() {}CodeWorker.dataURI = null;CodeWorker.name = null;CodeWorker.create = function() {var w,_this = this;w = new Worker(this.dataURI);w.onerror = function(event) {return console.error('Error in \"' + _this.name + '\" worker: \"' + event.message + '\"\\n', event);};return w;};return CodeWorker;})()
  '''
...
# Adds support for custom operators
CUSTOM_OPERATOR = /// ^(
	?: [+\-*%/^]
	 | [@^|]>
) ///
