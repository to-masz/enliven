...
#    o 'MatVec',                                 -> new Value $1
  ...
  Worker: [
    o 'WORKER SimpleAssignable',            -> new InlineWorker $2
    o 'WORKER SimpleAssignable Block',      -> new InlineWorker $2, $3
  ]
  
  Scene: [
    o 'SCENE SimpleAssignable',            -> new SceneClass $2
    o 'SCENE SimpleAssignable Block',      -> new SceneClass $2, $3
  ]
  
  Model: [
    o 'MODEL SimpleAssignable',            -> new ModelClass $2
    o 'MODEL SimpleAssignable Block',      -> new ModelClass $2, $3
  ]
  
  Shader: [
    o 'SHADER SimpleAssignable INDENT STRING TERMINATOR STRING OUTDENT',               -> new Shader $2, new Literal( $4 ), new Literal( $6 )
    o 'SHADER Object SimpleAssignable INDENT STRING TERMINATOR STRING OUTDENT',        -> new Shader $3, new Literal( $5 ), new Literal( $7 ), $2
  ]
...
#  ]
  ...
  Array: [
    ...
    o 'MATRIX_TYPE [ ]',                                    -> new MatVec [], $1
    o 'MATRIX_TYPE [ ArgList OptComma ]',                   -> new MatVec $3, $1
  ]
  ...
  Operation: [
    ...
    o 'Expression CUSTOM_OP Expression',        -> new Op $2, $1, $3
...
operators = [
  ...
  ['right',     'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS', 'WORKER', 'SCENE', 'MODEL']
  ['right',     'POST_IF']
]
